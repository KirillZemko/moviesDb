...
//  && lastViewedMovie != null && rateLastViewedMovie != null && lastViewedMovie.length > 50


for (let i = 1; i <= numberOfFilms; i++) {
  const lastViewedMovie = prompt('Один из последних просмотренных фильмов?', ''),
        rateLastViewedMovie = +prompt('На сколько оцените его?', '');//  && lastViewedMovie != null && rateLastViewedMovie != null && lastViewedMovie.length > 50
